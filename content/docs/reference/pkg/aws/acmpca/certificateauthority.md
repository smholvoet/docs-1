...
meta_desc: "Documentation for the aws.acmpca.CertificateAuthority resource with examples, input properties, output properties, lookup functions, and supporting types."
---
