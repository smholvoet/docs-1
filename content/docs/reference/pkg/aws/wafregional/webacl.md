...
meta_desc: "Documentation for the aws.wafregional.WebAcl resource with examples, input properties, output properties, lookup functions, and supporting types."
---
