...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/admissionregistration/v1beta1/#MutatingWebhookConfigurationList">MutatingWebhookConfigurationList</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#MutatingWebhookConfigurationList">MutatingWebhookConfigurationList</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_kubernetes/admissionregistration/v1beta1/#pulumi_kubernetes.admissionregistration/v1beta1.MutatingWebhookConfigurationList">MutatingWebhookConfigurationList</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_admissionregistration_k8s_io_v1beta1.MutatingWebhookConfigurationArgs]]</span> = None<span class="p">, </span><span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[_meta_v1.ListMetaArgs]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationList">NewMutatingWebhookConfigurationList</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationListArgs">MutatingWebhookConfigurationListArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationList">MutatingWebhookConfigurationList</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.AdmissionRegistration.V1Beta1.MutatingWebhookConfigurationList.html">MutatingWebhookConfigurationList</a></span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Beta1.MutatingWebhookConfigurationListArgs.html">MutatingWebhookConfigurationListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#MutatingWebhookConfigurationList">MutatingWebhookConfigurationList</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationListArgs">MutatingWebhookConfigurationListArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Types.Inputs.AdmissionRegistration.V1Beta1.MutatingWebhookConfigurationListArgs.html">MutatingWebhookConfigurationListArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
## MutatingWebhookConfigurationList Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Architecture and Concepts docs.

### Inputs

The MutatingWebhookConfigurationList resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#items_csharp" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhookconfiguration">List&lt;Mutating<wbr>Webhook<wbr>Configuration<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}List of MutatingWebhookConfiguration.{{% /md %}}</dd>
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhookconfiguration">[]Mutating<wbr>Webhook<wbr>Configuration<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}List of MutatingWebhookConfiguration.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhookconfiguration">Mutating<wbr>Webhook<wbr>Configuration[]</a></span>
    </dt>
    <dd>{{% md %}}List of MutatingWebhookConfiguration.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#items_python" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#mutatingwebhookconfiguration">Mutating<wbr>Webhook<wbr>Configuration<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}List of MutatingWebhookConfiguration.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the MutatingWebhookConfigurationList resource produces the following output properties:
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<h4 id="mutatingwebhookconfiguration">Mutating<wbr>Webhook<wbr>Configuration</h4>
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#MutatingWebhookConfiguration">input</a> and <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#MutatingWebhookConfiguration">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationTypeArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/admissionregistration/v1beta1?tab=doc#MutatingWebhookConfigurationTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
