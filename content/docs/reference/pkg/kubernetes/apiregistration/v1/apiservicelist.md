...
title_tag: "kubernetes.apiregistration.k8s.io/v1.APIServiceList"
meta_desc: "Documentation for the kubernetes.apiregistration.k8s.io/v1.APIServiceList resource with examples, input properties, output properties, lookup functions, and supporting types."
---
...
<div class="highlight"><pre class="chroma"><code class="language-typescript" data-lang="typescript"><span class="k">new </span><span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/apiregistration/v1/#APIServiceList">APIServiceList</a></span><span class="p">(</span><span class="nx">name</span><span class="p">:</span> <span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIServiceList">APIServiceList</a></span><span class="p">, </span><span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#CustomResourceOptions">CustomResourceOptions</a></span><span class="p">);</span></code></pre></div>
{{% /choosable %}}

{{% choosable language python %}}
<div class="highlight"><pre class="chroma"><code class="language-python" data-lang="python"><span class="k">def </span><span class="nx"><a href="/docs/reference/pkg/python/pulumi_kubernetes/apiregistration/v1/#pulumi_kubernetes.apiregistration/v1.APIServiceList">APIServiceList</a></span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">, </span><span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">, </span><span class="nx">items</span><span class="p">:</span> <span class="nx">Optional[Sequence[_apiregistration_k8s_io_v1.APIServiceArgs]]</span> = None<span class="p">, </span><span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[_meta_v1.ListMetaArgs]</span> = None<span class="p">)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language go %}}
<div class="highlight"><pre class="chroma"><code class="language-go" data-lang="go"><span class="k">func </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceList">NewAPIServiceList</a></span><span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#Context">Context</a></span><span class="p">, </span><span class="nx">name</span><span class="p"> </span><span class="nx">string</span><span class="p">, </span><span class="nx">args</span><span class="p"> </span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceListArgs">APIServiceListArgs</a></span><span class="p">, </span><span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v2/go/pulumi?tab=doc#ResourceOption">ResourceOption</a></span><span class="p">) (*<span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceList">APIServiceList</a></span>, error)</span></code></pre></div>
{{% /choosable %}}

{{% choosable language csharp %}}
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.ApiRegistration.V1.APIServiceList.html">APIServiceList</a></span><span class="p">(</span><span class="nx">string</span><span class="p"> </span><span class="nx">name<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceListArgs.html">APIServiceListArgs</a></span><span class="p"> </span><span class="nx">args<span class="p">, </span><span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.CustomResourceOptions.html">CustomResourceOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span></code></pre></div>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIServiceList">APIServiceList</a></span>
    </dt>
    <dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceListArgs">APIServiceListArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
<dl class="resources-properties">
    ...
    <dt
        ...
        <span>args</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="/docs/reference/pkg/dotnet/Pulumi.Kubernetes/Pulumi.Kubernetes.Types.Inputs.ApiRegistration.V1.APIServiceListArgs.html">APIServiceListArgs</a></span>
    </dt>
    <dd>
      The arguments to resource properties.
    </dd>
...
## APIServiceList Resource Properties {#properties}

To learn more about resource properties and how to use them, see [Inputs and Outputs]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) in the Architecture and Concepts docs.

### Inputs

The APIServiceList resource accepts the following [input]({{< relref "/docs/intro/concepts/inputs-outputs" >}}) properties:
...
<a href="#items_csharp" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservice">List&lt;APIService<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
...
<a href="#items_go" style="color: inherit; text-decoration: inherit;">Items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservice">[]APIService<wbr>Type</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#items_nodejs" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservice">APIService[]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#items_python" style="color: inherit; text-decoration: inherit;">items</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservice">APIService<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
All [input](#inputs) properties are implicitly available as output properties. Additionally, the APIServiceList resource produces the following output properties:
...
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIService">input</a> and <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#APIService">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceTypeArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceTypeOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#spec_csharp" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicespec">APIService<wbr>Spec<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Spec contains information for locating and communicating with a server{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicestatus">APIService<wbr>Status<wbr>Args</a></span>
    </dt>
    <dd>{{% md %}}Status contains derived information about an API server{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<a href="#spec_go" style="color: inherit; text-decoration: inherit;">Spec</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicespec">APIService<wbr>Spec</a></span>
    </dt>
    <dd>{{% md %}}Spec contains information for locating and communicating with a server{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#status_go" style="color: inherit; text-decoration: inherit;">Status</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicestatus">APIService<wbr>Status</a></span>
    </dt>
    <dd>{{% md %}}Status contains derived information about an API server{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<h4 id="apiservicecondition">APIService<wbr>Condition</h4>
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIServiceCondition">input</a> and <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#APIServiceCondition">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceConditionArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceConditionOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#type_csharp" style="color: inherit; text-decoration: inherit;">Type</a>
    ...
    <dd>{{% md %}}Type is the type of the condition.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#reason_csharp" style="color: inherit; text-decoration: inherit;">Reason</a>
    ...
    <dd>{{% md %}}Unique, one-word, CamelCase reason for the condition's last transition.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<h4 id="apiservicespec">APIService<wbr>Spec</h4>
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIServiceSpec">input</a> and <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#APIServiceSpec">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceSpecArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceSpecOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">
        <span id="grouppriorityminimum_csharp">
<a href="#grouppriorityminimum_csharp" style="color: inherit; text-decoration: inherit;">Group<wbr>Priority<wbr>Minimum</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}GroupPriorityMininum is the priority this group should have at least. Higher priority means that the group is preferred by clients over lower priority ones. Note that other versions of this group might specify even higher GroupPriorityMininum values such that the whole group gets a higher priority. The primary sort is based on GroupPriorityMinimum, ordered highest number to lowest (20 before 10). The secondary sort is based on the alphabetical comparison of the name of the object.  (v1.bar before v1.foo) We'd recommend something like: *.k8s.io (except extensions) at 18000 and PaaSes (OpenShift, Deis) are recommended to be in the 2000s{{% /md %}}</dd>
    <dt class="property-required"
            title="Required">
        <span id="versionpriority_csharp">
<a href="#versionpriority_csharp" style="color: inherit; text-decoration: inherit;">Version<wbr>Priority</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd>{{% md %}}VersionPriority controls the ordering of this API version inside of its group.  Must be greater than zero. The primary sort is based on VersionPriority, ordered highest to lowest (20 before 10). Since it's inside of a group, the number can be small, probably in the 10s. In case of equal version priorities, the version string will be used to compute the order inside a group. If the version string is "kube-like", it will sort above non "kube-like" version strings, which are ordered lexicographically. "Kube-like" versions start with a "v", then are followed by a number (the major version), then optionally the string "alpha" or "beta" and another number (the minor version). These are sorted first by GA > beta > alpha (where GA is a version with no suffix such as beta or alpha), and then by comparing major version, then minor version. An example sorted list of versions: v10, v2, v1, v11beta2, v10beta3, v3beta1, v12alpha1, v11alpha2, foo1, foo10.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#cabundle_csharp" style="color: inherit; text-decoration: inherit;">Ca<wbr>Bundle</a>
    ...
    <dd>{{% md %}}CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate. If unspecified, system trust roots on the apiserver are used.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#group_csharp" style="color: inherit; text-decoration: inherit;">Group</a>
    ...
    <dd>{{% md %}}Group is the API group name this server hosts{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
        <span id="insecureskiptlsverify_csharp">
<a href="#insecureskiptlsverify_csharp" style="color: inherit; text-decoration: inherit;">Insecure<wbr>Skip<wbr>TLSVerify</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
    <dd>{{% md %}}InsecureSkipTLSVerify disables TLS certificate verification when communicating with this server. This is strongly discouraged.  You should use the CABundle instead.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#service_csharp" style="color: inherit; text-decoration: inherit;">Service</a>
    ...
    <dd>{{% md %}}Service is a reference to the service for this API server.  It must communicate on port 443. If the Service is nil, that means the handling for the API groupversion is handled locally on this server. The call will simply delegate to the normal handler chain to be fulfilled.{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
...
<a href="#version_csharp" style="color: inherit; text-decoration: inherit;">Version</a>
    ...
    <dd>{{% md %}}Version is the API version this server hosts.  For example, "v1"{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">
        <span id="grouppriorityminimum_go">
<a href="#grouppriorityminimum_go" style="color: inherit; text-decoration: inherit;">Group<wbr>Priority<wbr>Minimum</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    ...
    <dt class="property-required"
            title="Required">
        <span id="versionpriority_go">
<a href="#versionpriority_go" style="color: inherit; text-decoration: inherit;">Version<wbr>Priority</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#group_go" style="color: inherit; text-decoration: inherit;">Group</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="insecureskiptlsverify_go">
<a href="#insecureskiptlsverify_go" style="color: inherit; text-decoration: inherit;">Insecure<wbr>Skip<wbr>TLSVerify</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">
        <span id="grouppriorityminimum_nodejs">
<a href="#grouppriorityminimum_nodejs" style="color: inherit; text-decoration: inherit;">group<wbr>Priority<wbr>Minimum</a>
</span>
        <span class="property-indicator"></span>
    ...
    <dt class="property-required"
            title="Required">
        <span id="versionpriority_nodejs">
<a href="#versionpriority_nodejs" style="color: inherit; text-decoration: inherit;">version<wbr>Priority</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number</span>
    </dt>
...
<a href="#group_nodejs" style="color: inherit; text-decoration: inherit;">group</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="insecureskiptlsverify_nodejs">
<a href="#insecureskiptlsverify_nodejs" style="color: inherit; text-decoration: inherit;">insecure<wbr>Skip<wbr>TLSVerify</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties">
    ...
    <dt class="property-required"
            title="Required">
        <span id="group_priority_minimum_python">
<a href="#group_priority_minimum_python" style="color: inherit; text-decoration: inherit;">group_<wbr>priority_<wbr>minimum</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    ...
    <dt class="property-required"
            title="Required">
        <span id="version_priority_python">
<a href="#version_priority_python" style="color: inherit; text-decoration: inherit;">version_<wbr>priority</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<a href="#group_python" style="color: inherit; text-decoration: inherit;">group</a>
    ...
    <dt class="property-optional"
            title="Optional">
        <span id="insecure_skip_tls_verify_python">
<a href="#insecure_skip_tls_verify_python" style="color: inherit; text-decoration: inherit;">insecure_<wbr>skip_<wbr>tls_<wbr>verify</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">bool</span>
    </dt>
...
<h4 id="apiservicestatus">APIService<wbr>Status</h4>
{{% choosable language nodejs %}}
> See the <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/input/#APIServiceStatus">input</a> and <a href="/docs/reference/pkg/nodejs/pulumi/kubernetes/types/output/#APIServiceStatus">output</a> API doc for this type.
{{% /choosable %}}

{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceStatusArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#APIServiceStatusOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#conditions_csharp" style="color: inherit; text-decoration: inherit;">Conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicecondition">List&lt;APIService<wbr>Condition<wbr>Args&gt;</a></span>
    </dt>
    <dd>{{% md %}}Current service state of apiService.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<a href="#conditions_go" style="color: inherit; text-decoration: inherit;">Conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicecondition">[]APIService<wbr>Condition</a></span>
    </dt>
    <dd>{{% md %}}Current service state of apiService.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
<a href="#conditions_python" style="color: inherit; text-decoration: inherit;">conditions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#apiservicecondition">APIService<wbr>Condition<wbr>Args]</a></span>
    </dt>
    <dd>{{% md %}}Current service state of apiService.{{% /md %}}</dd>
</dl>
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ListMetaArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ListMetaOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ManagedFieldsEntryArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ManagedFieldsEntryOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ObjectMetaArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ObjectMetaOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#OwnerReferenceArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#OwnerReferenceOutput">output</a> API doc for this type.
{{% /choosable %}}
...
{{% choosable language go %}}
> See the <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ServiceReferenceArgs">input</a> and <a href="https://pkg.go.dev/github.com/pulumi/pulumi-kubernetes/sdk/v2/go/kubernetes/apiregistration/v1?tab=doc#ServiceReferenceOutput">output</a> API doc for this type.
{{% /choosable %}}
...
<a href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd>{{% md %}}Name is the name of the service{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
        <span id="namespace_csharp">
<a href="#namespace_csharp" style="color: inherit; text-decoration: inherit;">Namespace</a>
    ...
    <dd>{{% md %}}Namespace is the namespace of the service{{% /md %}}</dd>
    <dt class="property-optional"
            title="Optional">
        <span id="port_csharp">
